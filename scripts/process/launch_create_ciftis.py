...
indir = '/projects/b1108/projects/adversity_networks/data/processed/neuroimaging/fmriprep_25.2.4/'
...
for subdir in subdirs:
    ...
    if len(sub_bold_imgs) > 0 and len(output_imgs) == 0:
        print(sub)
        cmd = ['bash /projects/b1108/projects/adversity_networks/scripts/process/create_ciftis.sh -s', sub]
        create_ciftis_script = launchdir+sub+'_create_ciftis_run.sh'
        os.system('cat /projects/b1108/projects/adversity_networks/scripts/process/sbatchinfo_9hr_10G_general.sh > '+create_ciftis_script)
