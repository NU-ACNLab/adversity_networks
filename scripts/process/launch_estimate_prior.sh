...
#sbatch -o /projects/b1108/projects/adversity_networks/data/processed/neuroimaging/launch/prior/estimate_prior.txt /projects/b1108/projects/adversity_networks/scripts/process/launch_estimate_prior.sh