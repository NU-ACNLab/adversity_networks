...
sessions_func=`find ${neurodir}/fmriprep_25.2.4/${sub}/ses-* -name "func" | cut -d "/" -f 11`
sessions_anat=`find ${neurodir}/fmriprep_25.2.4/${sub}/ses-* -name "anat" | cut -d "/" -f 11`
...
for ses in ${sessions}; do
    echo ${ses}
    task_paths=`find ${neurodir}/fmriprep_25.2.4/${sub}/${ses}/func/ -name "*_space-T1w_desc-preproc_bold.nii.gz"`
    taskruns=""
    ...
    anatindir=${neurodir}/fmriprep_25.2.4/${sub}/${ses}/anat
    funcindir=${neurodir}/fmriprep_25.2.4/${sub}/${ses}/func

    # this is the feesurfer surf dir: for registration (spherical)
    freedir=${neurodir}/fmriprep_25.2.4/sourcedata/freesurfer/${sub}_${ses}

    # set output directories
    funcoutdir=${outdir}/surf/${sub}/${ses}/func
    mkdir ${funcoutdir}

    # set output directories... edit
    anatoutdir=${outdir}/surf/${sub}/${ses}/anat
    mkdir ${anatoutdir}

    ##### 2) convert .reg files into giftis... edit
    # left
    ...
    mri_convert ${freedir}/mri/T1.mgz ${anatoutdir}/fs_T1w.nii.gz
