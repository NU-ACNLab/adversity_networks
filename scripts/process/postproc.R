### This script does postprocessing on the task data
###
### Ellyn Butler
### March 18, 2026
...
#indir <- '/Users/flutist4129/Documents/Northwestern/projects/adversity_networks/data/processed/neuroimaging/'

motdir <- '/projects/b1108/projects/adversity_networks/data/processed/neuroimaging/fmriprep_25.2.4/'
#motdir <- '/Users/flutist4129/Documents/Northwestern/projects/adversity_networks/data/processed/neuroimaging/fmriprep_25.2.4/'
...
for (dscalar in dscalars) {
    ...
    write_cifti(cii_out, paste0(indir, 'surf/sub-', subid, '/ses-', sesid, '/func/sub-', subid, 
                    '_ses-', sesid, '_', taskrun, '_space-fsLR_desc-postproc_bold.dscalar.nii'))
